/* 
  ...
  What should you do if the provided start and end index is out of bounds?
*/
 ...
 * @param {number} endIdx
 * @returns {Array<any>} The slice of the given arr from startIdx exclusive
 *    to endIdx.
 */
...
function concat(items1, items2) {
    let newArray = items1.push(items2)
    return newArray
}
